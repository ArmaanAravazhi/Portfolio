import donald_1 from '../assets/donald_1.jpg';
import { ChevronDown, Github, Linkedin, Mail, Instagram } from 'lucide-react';

export default function Hero() {
    return <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
